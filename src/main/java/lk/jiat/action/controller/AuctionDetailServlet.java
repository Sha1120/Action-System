...
public class AuctionDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Auction> auctions = mockAuctions();
        ...
        if (selectedAuction != null) {
            request.setAttribute("auction", selectedAuction);
            RequestDispatcher dispatcher = request.getRequestDispatcher("auction-detail.jsp");
            dispatcher.forward(request, response);
        } else {
            response.sendRedirect("auctions"); // fallback if auction not found
        }
    }
}
